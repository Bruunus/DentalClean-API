...
public class ListarService {
	...
	public List<PacienteDTO> listarTodosPacientes() {		
		...
		pacientes.forEach(paciente -> {
			...
			pacienteDTO.setId(paciente.getId_cadastro_paciente());
...
//			Integer numeroCarteirinhaInteger = paciente.getNumeroCarteirinha();
...
//			pacienteDTO.setNumeroCarteirinha(numeroCarteirinhaString);
			pacienteDTO.setNumeroCarteirinha(pacienteDTO.getNumeroCarteirinha());
			
			pacienteDTO.setRua(paciente.getRua());
			
			Integer numeroInteger = paciente.getNumero();
...
//				Integer numeroCarteirinhaInteger = data.getNumeroCarteirinha();
//				String numeroCarteirinhaString = pacienteDTO.conversorString(numeroCarteirinhaInteger);
//				pacienteDTO.setNumeroCarteirinha(numeroCarteirinhaString);	
				...
				Integer numeroInteger = data.getNumero();
				String numeroString = pacienteDTO.conversorString(numeroInteger);				
				pacienteDTO.setNumero(numeroString);
