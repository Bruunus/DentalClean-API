...
public class ExibirDadosController {
	 ...
	 */
	@GetMapping("/api/read/listar/paciente/seach")
	 ...
	 * @return Mensagem HTTP
	 */
	@GetMapping("/api/read/listar/dentista/seach")
